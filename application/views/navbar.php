            ...
            <div class="container">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="<?php echo site_url();?>dashboard/"><?php echo _tr($site_title); ?></a>
                </div>
            
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                    <li><a href="<?php echo site_url();?>dashboard"><i class="fa fa-tachometer" aria-hidden="true"></i><?php echo _tr("dashboard"); ?></a></li>
                    <?php
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo site_url();?>user/changeuser"><?php echo _tr("_edit_profile"); ?></a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="<?php echo base_url().'auth/logout' ?>"><?php echo _tr("_logout"); ?></a></li>
                      </ul>
                    </li>
                  </ul>
                </div><!-- /.navbar-collapse -->
